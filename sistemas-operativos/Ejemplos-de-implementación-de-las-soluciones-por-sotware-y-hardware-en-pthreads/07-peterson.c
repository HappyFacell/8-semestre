...
void *tfunc(void *args)
{
	...
	for(n=0;n<10;n++)
	{
		rs();	
		// Sección de entrada
		flag[i]=TRUE;	x();	// Pongo mi bandera indicando que quiero entrar
		turno=j;	x();		// Soy educado, y cedo el turno al otro si también quiere entrar
		while(flag[j] && turno!=i);	// Espera	
